...
class AdvectionDataset(PTDataset):
    """
    AdvectionDataset wraps data from the advection equation in 1 spatial dimension.
...
def load_advection_1d(
    ...
    """
    Legacy function to load the Advection equation dataset
    ...
    """
    advection_dataset = AdvectionDataset(
        root_dir=data_root,
        n_train=n_train,
        n_tests=n_test,
        batch_size=batch_size,
    ...
    train_loader = DataLoader(
        advection_dataset.train_db, batch_size=batch_size, shuffle=True
    )

    test_loaders = {
        resolution: DataLoader(
            advection_dataset.test_dbs[resolution],
    ...
    return train_loader, test_loaders, advection_dataset.data_processor
