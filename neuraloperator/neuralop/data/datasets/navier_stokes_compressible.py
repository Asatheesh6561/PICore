...
class NavierStokesCompressibleDataset(PTDataset):
    """
    NavierStokesCompressibleDataset wraps data from the ns_com equation in 1 spatial dimension.
...
def load_ns_com(
    ...
    """
    Legacy function to load the NavierStokesCompressible equation dataset
    ...
    """
    ns_incom_dataset = NavierStokesCompressibleDataset(
        root_dir=data_root,
        n_train=n_train,
        n_tests=n_test,
        batch_size=batch_size,
