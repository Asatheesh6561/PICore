...
class NavierStokesIncompressibleDataset(PTDataset):
    """
    NavierStokesIncompressibleDataset wraps data from the ns_incom equation in 2 spatial dimension.
    ...
    def __init__(
        ...
        super().__init__(
            ...
            dataset_name="ns_incom",
        )


def load_ns_incom_2d(
    ...
    """
    Legacy function to load the NavierStokesIncompressible equation dataset
    ...
    """
    ns_incom_dataset = NavierStokesIncompressibleDataset(
        root_dir=data_root,
        n_train=n_train,
        n_tests=n_test,
        batch_size=batch_size,
    ...
    train_loader = DataLoader(
        ns_incom_dataset.train_db, batch_size=batch_size, shuffle=True
    )

    test_loaders = {
        resolution: DataLoader(
            ns_incom_dataset.test_dbs[resolution],
    ...
    return train_loader, test_loaders, ns_incom_dataset.data_processor
