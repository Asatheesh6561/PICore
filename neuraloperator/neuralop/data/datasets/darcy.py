...
class DarcyDataset(PTDataset):
    """
    DarcyDataset wraps data from the darcy equation in 1 spatial dimension.
...
def load_darcy_2d(
    ...
    """
    Legacy function to load the Darcy equation dataset
    ...
    train_loader = DataLoader(
        darcy_dataset.train_db, batch_size=batch_size, shuffle=True
    )
    ...
    return train_loader, test_loaders, darcy_dataset.data_processor
